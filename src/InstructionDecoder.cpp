...
{
    instr_cache[0x30200073] = Instruction{ Instruction::Type::R,
                                           IName::MRET,
                                           Fields{
                                             .OPCode = 0b1110011,
                                             .rd = 0b00000,
    ...
    instr_cache[0x10200073] = Instruction{ Instruction::Type::R,
                                           IName::SRET,
                                           Fields{
                                             .OPCode = 0b1110011,
                                             .rd = 0b00000,
...
const std::map<IName, uint8_t> InstructionDecoder::i_opcodes = {
    { IName::LB, 0b0000011 },     { IName::LBU, 0b0000011 },
    { IName::LH, 0b0000011 },     { IName::LHU, 0b0000011 },
    { IName::LW, 0b0000011 },     { IName::LD, 0b0000011 },
    { IName::LWU, 0b0000011 },    { IName::ADDI, 0b0010011 },
    { IName::ADDIW, 0b0011011 },  { IName::SLTI, 0b0010011 },
    { IName::SLTIU, 0b0010011 },  { IName::XORI, 0b0010011 },
    { IName::ORI, 0b0010011 },    { IName::ANDI, 0b0010011 },
    ...
    { IName::JALR, 0b1100111 },   { IName::FENCE, 0b0001111 },
    { IName::FENCEI, 0b0001111 }, { IName::ECALL, 0b1110011 },
    { IName::EBREAK, 0b1110011 }, { IName::CSRRW, 0b1110011 },
    { IName::CSRRS, 0b1110011 },  { IName::CSRRC, 0b1110011 },
    { IName::CSRRWI, 0b1110011 }, { IName::CSRRSI, 0b1110011 },
    { IName::CSRRCI, 0b1110011 }, { IName::FLW, 0b0000111 },
};

const std::map<IName, uint8_t> InstructionDecoder::r_opcodes = {
    { IName::ADD, 0b0110011 },      { IName::ADDW, 0b0111011 },
    { IName::SUB, 0b0110011 },      { IName::SUBW, 0b0111011 },
    { IName::SLL, 0b0110011 },      { IName::SLLW, 0b0111011 },
    { IName::SLT, 0b0110011 },      { IName::SLTU, 0b0110011 },
    { IName::XOR, 0b0110011 },      { IName::SRL, 0b0110011 },
    { IName::SRLW, 0b0111011 },     { IName::SRA, 0b0110011 },
    { IName::SRAW, 0b0111011 },     { IName::OR, 0b0110011 },
    { IName::AND, 0b0110011 },

    { IName::MUL, 0b0110011 },      { IName::MULH, 0b0110011 },
    { IName::MULHSU, 0b0110011 },   { IName::MULHU, 0b0110011 },
    { IName::DIV, 0b0110011 },      { IName::DIVU, 0b0110011 },
    { IName::REM, 0b0110011 },      { IName::REMU, 0b0110011 },
    { IName::MULW, 0b0111011 },     { IName::DIVW, 0b0111011 },
    { IName::DIVUW, 0b0111011 },    { IName::REMW, 0b0111011 },
    { IName::REMUW, 0b0111011 },

    { IName::LRW, 0b0101111 },      { IName::SCW, 0b0101111 },
    { IName::AMOSWAPW, 0b0101111 }, { IName::AMOADDW, 0b0101111 },
    { IName::AMOXORW, 0b0101111 },  { IName::AMOANDW, 0b0101111 },
    { IName::AMOORW, 0b0101111 },   { IName::AMOMINW, 0b0101111 },
    { IName::AMOMAXW, 0b0101111 },  { IName::AMOMINUW, 0b0101111 },
    { IName::AMOMAXUW, 0b0101111 }, { IName::AMOSWAPD, 0b0101111 },
    { IName::AMOADDD, 0b0101111 },  { IName::AMOXORD, 0b0101111 },
    { IName::AMOANDD, 0b0101111 },  { IName::AMOORD, 0b0101111 },
    { IName::AMOMIND, 0b0101111 },  { IName::AMOMAXD, 0b0101111 },
    { IName::AMOMINUD, 0b0101111 }, { IName::AMOMAXUD, 0b0101111 },
    { IName::LRD, 0b0101111 },      { IName::SCD, 0b0101111 },

    { IName::FADDS, 0b1010011 },    { IName::FSUBS, 0b1010011 },
    { IName::FMULS, 0b1010011 },    { IName::FDIVS, 0b1010011 },
    { IName::FSQRTS, 0b1010011 },   { IName::FSGNJS, 0b1010011 },
    { IName::FSGNJNS, 0b1010011 },  { IName::FSGNJXS, 0b1010011 },
    { IName::FMINS, 0b1010011 },    { IName::FMAXS, 0b1010011 },
    { IName::FCVTWS, 0b1010011 },   { IName::FCVTWUS, 0b1010011 },
    { IName::FMVXW, 0b1010011 },    { IName::FEQS, 0b1010011 },
    { IName::FLTS, 0b1010011 },     { IName::FLES, 0b1010011 },
    { IName::FCLASSS, 0b1010011 },  { IName::FCVTSW, 0b1010011 },
    { IName::FCVTSWU, 0b1010011 },  { IName::FMVWX, 0b1010011 },

    { IName::FCVTLS, 0b1010011 },   { IName::FCVTLUS, 0b1010011 },
    { IName::FCVTLS, 0b1010011 },   { IName::FCVTSLU, 0b1010011 },
};

const std::map<IName, uint8_t> InstructionDecoder::r4_opcodes = {
    { IName::FMADDS, 0b1000011 },  { IName::FMSUBS, 0b1000111 },
    { IName::FNMSUBS, 0b1001011 }, { IName::FNMADDS, 0b1001111 },
    { IName::FNMADDS, 0b1001111 },
};

const std::map<IName, uint8_t> InstructionDecoder::b_opcodes = {
    { IName::BEQ, 0b1100011 },  { IName::BNE, 0b1100011 },
    { IName::BLT, 0b1100011 },  { IName::BGE, 0b1100011 },
    { IName::BLTU, 0b1100011 }, { IName::BGEU, 0b1100011 },
};

const std::map<IName, uint8_t> InstructionDecoder::s_opcodes = {
    { IName::SB, 0b0100011 },  { IName::SH, 0b0100011 },
    { IName::SW, 0b0100011 },  { IName::SD, 0b0100011 },
    { IName::FSW, 0b0100111 },
};
...
const std::map<IName, uint8_t> InstructionDecoder::i_funct3 = {
    { IName::LB, 0b000 },     { IName::LH, 0b001 },
    { IName::LW, 0b010 },     { IName::LBU, 0b100 },
    { IName::LHU, 0b101 },    { IName::LD, 0b011 },
    { IName::LWU, 0b110 },    { IName::ADDI, 0b000 },
    { IName::ADDIW, 0b000 },  { IName::SLTI, 0b010 },
    { IName::SLTIU, 0b011 },  { IName::XORI, 0b100 },
    { IName::ORI, 0b110 },    { IName::ANDI, 0b111 },
    { IName::SLLI, 0b001 },   { IName::SRLI, 0b101 },
    { IName::SRAI, 0b101 },   { IName::SLLIW, 0b001 },
    { IName::SRLIW, 0b101 },  { IName::SRAIW, 0b101 },
    { IName::ECALL, 0b000 },  { IName::EBREAK, 0b000 },
    { IName::FENCE, 0b000 },  { IName::FENCEI, 0b001 },
    { IName::CSRRW, 0b001 },  { IName::CSRRS, 0b010 },
    { IName::CSRRC, 0b011 },  { IName::CSRRWI, 0b101 },
    { IName::CSRRSI, 0b110 }, { IName::CSRRCI, 0b111 },
    { IName::JALR, 0b000 },   { IName::FLW, 0b010 },
};

const std::map<IName, uint8_t> InstructionDecoder::r_funct3 = {
    { IName::ADD, 0b000 },      { IName::ADDW, 0b000 },
    { IName::SUB, 0b000 },      { IName::SUBW, 0b000 },
    { IName::SLL, 0b001 },      { IName::SLLW, 0b001 },
    { IName::SRLW, 0b101 },     { IName::SRAW, 0b101 },
    { IName::SLT, 0b010 },      { IName::SLTU, 0b011 },
    { IName::XOR, 0b100 },      { IName::SRL, 0b101 },
    { IName::SRA, 0b101 },      { IName::OR, 0b110 },
    { IName::AND, 0b111 },      { IName::LRW, 0b010 },
    { IName::SCW, 0b010 },      { IName::MUL, 0b000 },
    { IName::MULH, 0b001 },     { IName::MULHSU, 0b010 },
    { IName::MULHU, 0b011 },    { IName::DIV, 0b100 },
    { IName::DIVU, 0b101 },     { IName::REM, 0b110 },
    { IName::REMU, 0b111 },     { IName::MULW, 0b000 },
    { IName::DIVW, 0b100 },     { IName::DIVUW, 0b101 },
    { IName::REMW, 0b110 },     { IName::REMUW, 0b111 },
    { IName::AMOSWAPW, 0b010 }, { IName::AMOADDW, 0b010 },
    { IName::AMOXORW, 0b010 },  { IName::AMOANDW, 0b010 },
    { IName::AMOORW, 0b010 },   { IName::AMOMINW, 0b010 },
    { IName::AMOMAXW, 0b010 },  { IName::AMOMINUW, 0b010 },
    { IName::AMOMAXUW, 0b010 },

    { IName::AMOSWAPD, 0b011 }, { IName::AMOADDD, 0b011 },
    { IName::AMOXORD, 0b011 },  { IName::AMOANDD, 0b011 },
    { IName::AMOORD, 0b011 },   { IName::AMOMIND, 0b011 },
    { IName::AMOMAXD, 0b011 },  { IName::AMOMINUD, 0b011 },
    { IName::AMOMAXUD, 0b011 }, { IName::LRD, 0b011 },
    { IName::SCD, 0b011 },

    { IName::FSGNJS, 0b000 },   { IName::FSGNJNS, 0b001 },
    { IName::FSGNJXS, 0b010 },  { IName::FMINS, 0b000 },
    { IName::FMAXS, 0b001 },    { IName::FMVXW, 0b000 },
    { IName::FEQS, 0b010 },     { IName::FLTS, 0b001 },
    { IName::FLES, 0b000 },     { IName::FCLASSS, 0b001 },
    { IName::FMVWX, 0b000 },
};

const std::map<IName, uint8_t> InstructionDecoder::r4_funct2 = {
    { IName::FMADDS, 0b00 },  { IName::FMSUBS, 0b00 },
    { IName::FNMSUBS, 0b00 }, { IName::FNMADDS, 0b00 },
    { IName::FNMADDS, 0b00 },
};

const std::map<IName, uint8_t> InstructionDecoder::b_funct3 = {
    { IName::BEQ, 0b000 }, { IName::BNE, 0b001 },  { IName::BLT, 0b100 },
    { IName::BGE, 0b101 }, { IName::BLTU, 0b110 }, { IName::BGEU, 0b111 },
};

const std::map<IName, uint8_t> InstructionDecoder::s_funct3 = {
    { IName::SB, 0b000 }, { IName::SH, 0b001 },  { IName::SW, 0b010 },
    { IName::SD, 0b011 }, { IName::FSW, 0b010 },
};
...
const std::map<IName, uint8_t> InstructionDecoder::i_funct7 = {
    { IName::SLLI, 0b0000000 },  { IName::SRLI, 0b0000000 },
    { IName::SRAI, 0b0100000 },  { IName::SLLIW, 0b0000000 },
    { IName::SRLIW, 0b0000000 }, { IName::SRAIW, 0b0100000 },
};
...
Instruction InstructionDecoder::decode_r(uint32_t inst)
{
    ...
    for (auto& [ins, f3] : r_funct3) {
        ...
        if (f.OPCode == ins_opcode && f3 == f.funct3 && ins_f7 == f.funct7) {
            return Instruction(
              Instruction::Type::R, ins, f, get_string_name(ins));
        } else if (f.OPCode == ins_opcode && f3 == f.funct3 &&
                   f.OPCode == AM_OPCODE) {
...
bool InstructionDecoder::ignore_f3(uint32_t inst)
{
    ...
    return (f7 == 0b0000000 || f7 == 0b0000100 || f7 == 0b0001000 ||
            f7 == 0b0001100 || f7 == 0b0101100 || f7 == 0b1100000 ||
            f7 == 0b1101000);
}
...
Instruction InstructionDecoder::decode_r4(uint32_t inst)
{
    ...
    for (auto& [ins, f2] : r4_funct2) {
        ...
        if (f.OPCode == ins_opcode && f2 == f.funct2) {
            return Instruction(
              Instruction::Type::R4, ins, f, get_string_name(ins));
        }
    }
    return Instruction(Instruction::Type::WRONG, IName::XXX, f, "XXX");
}
...
Instruction InstructionDecoder::decode_i(uint32_t inst)
{
    ...
    for (const auto& [ins, f3] : i_funct3) {
        if (get_opcode(ins, Instruction::Type::I) == f.OPCode &&
            f3 == f.funct3 && !is_shift_imm_32_instruction(ins) &&
            !is_shift_imm_64_instruction(ins)) {
            if ((ins == IName::ECALL && f.imm == 0) ||
                (ins == IName::EBREAK && f.imm == 1) ||
                (ins != IName::EBREAK && ins != IName::ECALL)) {
                return Instruction(
                  Instruction::Type::I, ins, f, get_string_name(ins));
            }
        } else if (is_shift_imm_32_instruction(ins) &&
                   f.OPCode == get_opcode(ins, Instruction::Type::I) &&
...
Instruction InstructionDecoder::decode_b(uint32_t inst)
{
    ...
    for (const auto& [ins, f3] : b_funct3) {
        if (f.OPCode == get_opcode(ins, Instruction::Type::B) &&
            f3 == f.funct3) {
            return Instruction(
              Instruction::Type::B, ins, f, get_string_name(ins));
        }
    }
    return Instruction(Instruction::Type::WRONG, IName::XXX, f, "XXX");
}
...
Instruction InstructionDecoder::decode_s(uint32_t inst)
{
    ...
    for (const auto& [ins, f3] : s_funct3) {
        if (f.OPCode == get_opcode(ins, Instruction::Type::S) &&
            f3 == f.funct3) {
            return Instruction(
              Instruction::Type::S, ins, f, get_string_name(ins));
        }
    }
    return Instruction(Instruction::Type::WRONG, IName::XXX, f, "XXX");
}
...
Instruction InstructionDecoder::decode_j(uint32_t inst)
{
    ...
    for (const auto& [ins, op] : j_opcodes) {
        if (op == f.OPCode) {
            return Instruction(
              Instruction::Type::J, ins, f, get_string_name(ins));
        }
    }
    return Instruction(Instruction::Type::WRONG, IName::XXX, f, "XXX");
}
...
Instruction InstructionDecoder::decode_u(uint32_t inst)
{
    ...
    for (const auto& [ins, op] : u_opcodes) {
        if (op == f.OPCode) {
            return Instruction(
              Instruction::Type::U, ins, f, get_string_name(ins));
        }
    }
    return Instruction(Instruction::Type::WRONG, IName::XXX, f, "XXX");
}
